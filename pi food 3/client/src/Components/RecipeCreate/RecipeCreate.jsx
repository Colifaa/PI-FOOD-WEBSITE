...
<div className="containercheck">
  <fieldset className="orgcontcheck">
     <legend className="leyenda">Elija uno o más tipos de dietas</legend>
 ...
 <input className="checkdietas" type="checkbox"
  name={e.name} 
  value={e.name} 
  onChange={(e) => handlerCheckbox(e)}></input>
      </div>
   )
      })
  }
 ...
 <textarea value={dataSteps} name="name" onChange={e => setDataSteps(e.target.value)} row="8" col="80"></textarea>
  <div>
 <input className= "botonAgregar" type="submit" name="agregar" value="Agregar paso" onClick={e => handlerAddSteps(e)} ></input>
     <input className="botonQuitarPaso" type="submit" name="borrar" value="Borrar último" onClick={e => handlerDeleteLast(e)}></input>
 <input className="botonQuitarTodo" type="submit" name="borrartodo" value="Borrar Todo" onClick={e => handlerDeleteAll(e)} ></input>
  </div>
    </div>
